...
from core_lib.services.queue.queue_service import send_message_to_queue, get_auth_event_queue_url
...
def replicate_auth_event(func):
    ...
    def wrapper(*args, **kwargs):
        ...
        send_message_to_queue(message, region=region, queue_url=get_auth_event_queue_url(region=region))
...
def confirm_sign_up(username: str, code: str):
    return AUTH_SERVICE_IMPL.confirm_sign_up(
