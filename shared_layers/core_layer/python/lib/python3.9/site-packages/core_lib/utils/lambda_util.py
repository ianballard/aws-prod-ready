        ...
        def wrapper(event, context):
            try:
                ...
                try:
                    ...
                    xray_recorder.current_subsegment().put_metadata('event', event, 'ProcessingEvent')
                    xray_recorder.current_subsegment().put_annotation('EventSize', len(json.dumps(event)))
