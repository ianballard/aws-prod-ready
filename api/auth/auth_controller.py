...
def signup(api_request: ApiRequest):
    ...
    return ApiResponse(request_headers=api_request.headers, status_code=201, response_body=signup_response).format()
...
def authenticate(api_request: ApiRequest):
    ...
    return ApiResponse(request_headers=api_request.headers, status_code=200, response_body=authentication_response).format()
